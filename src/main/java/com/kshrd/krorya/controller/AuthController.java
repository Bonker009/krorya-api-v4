...
import com.kshrd.krorya.exception.*;
...
//        OtpDTO otp = otpService
    ...
    public ResponseEntity<?> login(@Valid @RequestBody AuthRequest authRequest) throws Exception {
        ...
        log.info("userDetail in controller : {}", userDetails.toString());
