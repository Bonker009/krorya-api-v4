...
//    @Delete("""
//    DELETE FROM recipe_ingredient WHERE recipe_id = #{recipeId} AND ingredient_id = #{ingredientId}
//    """)
//    void deleteIngredientByRecipeIdAndIngredientId(UUID recipeId, UUID ingredientId);
}
