...
//    @SelectProvider(type = GroceryListProvider.class, method = "getGroceryListById")
    @Select("""
...
//        WHERE grocery_id = #{groceryId}
//    """)
//    GroceryList findGroceryListByGroceryId(UUID groceryId);
//
//    @Update("""
//        UPDATE grocery_ingredient
//        SET is_bought = #{groceryIngredients.isBought}
//        WHERE ingredient_id = #{ingredientId}
//        AND grocery_id = #{groceryId}
//    """)
//    void updateIngredientStatus(@Param("ingredientId") UUID ingredientId,
//                                @Param("groceryId") UUID groceryId,
//                                @Param("GroceryRecipe") GroceryListRequest groceryIngredients);
//
    @Insert("""
